...
Non è l'unico modo per rappresentare gli elementi del [[2.3 Product Backlog|product backlog]]: *Ron Jeffries le descrive come le tre C: **card**, **conversation** e **confirmation**.*
...
- **features:** nell'ordine delle settimane e quindi troppo grande per un solo [[2.5 Sprint|sprint]];
- **sprintable stories:** nell'ordine dei giorni in termini di dimensioni e quindi abbastanza piccolo da adattarsi a uno [[2.5 Sprint|sprint]] ed essere implementato;
...
- **piccoli:** cioè è possibile realizzarli durante una [[2.5 Sprint|sprint]];
- **testabili**.
