...
- **Portfolio Planning:** si identificano i backlog-items che si devono realizzare nel corso di questo [[2.5 Sprint|sprint]]. Non necessariamente devono essere nuovi prodotti, potrebbero essere anche delle revisioni dei processi in corso;
...
- **fixed scope burnout chart:** il nostro obiettivo è comunicare la gamma di funzionalità che prevediamo di completare e il nostro progresso [[2.5 Sprint|sprint]] per [[2.5 Sprint|sprint]]. Mostra la quantità totale di lavoro incompiuto che rimane in ogni [[2.5 Sprint|sprint]];
...
- **[[2.3 Product Backlog|Product backlog]]:** prima della pianificazione dello [[2.5 Sprint|sprint]], gli elementi del [[2.3 Product Backlog|product backlog]] più in alto sono stati portati in uno stato pronto;
- **Velocità del team:** la velocità storica del team è un indicatore di quanto lavoro è pratico per il team completare in uno [[2.5 Sprint|sprint]];
...
- **Capacità del team:** le capacità tengono conto delle persone che fanno parte del team, delle capacità di ciascun membro del team e della disponibilità di ciascuna persona nel prossimo [[2.5 Sprint|sprint]];
- **Obiettivo dello [[2.5 Sprint|sprint]] iniziale:** questo è l'obiettivo aziendale che il product owner vorrebbe vedere raggiunto durante lo [[2.5 Sprint|sprint]].

Ci sono due approcci allo [[2.5 Sprint|sprint]] planning:
...
Quando si vuole determinare la capacità devono essere prese in considerazione numerose variabili: il tempo personale del team, il lavoro al di fuori dello [[2.5 Sprint|sprint]] e il lavoro di altri progetti.
