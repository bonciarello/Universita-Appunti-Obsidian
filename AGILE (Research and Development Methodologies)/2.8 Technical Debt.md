...
- *cercare di darne una rappresentazione tangibile:* generalmente si realizza andando a realizzare un *Tecnical Debt Backlog* associato al [[2.3 Product Backlog|product backlog]].
