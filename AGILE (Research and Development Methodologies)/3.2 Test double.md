...
- **Test di [[2.2 Regressione|regressione]]:** una volta trovato un bug, aggiungi un test nella tua suite che lo "copra".
...
- **Fake:** test double con un comportamento programmabile, che simula quello dell'oggetto reale (per esempio un oggetto che implementa un [[2.4 Database|database]] in memoria invece di accedere a un [[2.4 Database|database]] reale).
