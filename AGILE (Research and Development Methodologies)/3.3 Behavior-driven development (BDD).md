...
In BDD possono esserci più fasi di discovery e nessun vincolo sul "quando" possono aver luogo: tuttavia se applichi SCRUM la "scelta naturale" è quella di allinearsi con le cerimonie standard dello [[2.5 Sprint|sprint]], in particolare la pianificazione dello [[2.5 Sprint|sprint]] o subito dopo la fase di stima per ogni elemento del backlog.
