...
---
Nell'[[0.00 Ingegneria del Software|ingegneria del software]] tradizionale:
...
Considera anche che queste fasi sono un esempio minimo e potrebbero essere aggiunti altri tipi di "gate" per le versioni candidate: test manuale, test di [[3.1 Sicurezza|sicurezza]], test delle prestazioni e altri test non funzionali.
