...
![](img/sezione6/scrumFramework.PNG)

### [[Sprint Planning]]
Il risultato della **[[Sprint Planning|sprint planning]]** è:
...
Si acquisisce fiducia nel fatto che il team di sviluppo abbia preso un impegno ragionevole. I membri del team creano un secondo *backlog* durante la pianificazione dello [[Sprint|sprint]], chiamato **[[Sprint|sprint]] backlog**.

### [[Product Backlog]]
Il **[[Product Backlog|product backlog]]** è un elenco prioritario (o ordinato) del lavoro da svolgere: un artefatto in continua evoluzione.
...
### Spints
Con gli **[[Sprint|sprint]]** il lavoro viene eseguito in iterazioni o cicli fino a un mese di calendario chiamati. Il lavoro completato in ogni [[Sprint|sprint]] dovrebbe creare qualcosa di valore tangibile per il cliente o l'utente.

Gli [[Sprint|sprint]] sono *timebox*, quindi hanno sempre una data di inizio e fine fissa e generalmente dovrebbero avere tutti la stessa durata, solitamente di 2 mesi.

![](img/sezione6/sprints.png)

### [[Sprint Planning]]
Un [[Product Backlog|product backlog]] può rappresentare molte settimane o mesi di lavoro, che è molto più di quanto possa essere completato in un singolo, breve [[Sprint|sprint]].

Durante lo **[[Sprint Planning|sprint planning]]**, si determina il sottoinsieme più importante di elementi del [[Product Backlog|product backlog]] da costruire nello [[Sprint|sprint]] successivo.

Il proprietario e il team di sviluppo concordano uno **[[Sprint|sprint]] goal**: determina gli elementi ad alta priorità che il team può realizzare realisticamente *lavorando a un ritmo sostenibile*.

### [[Sprint]] Backlog
I team di sviluppo suddividono ogni caratteristica mirata in una serie di attività. La raccolta di queste attività e del PBI associato costituisce lo **[[Sprint|sprint]] backlog**.

![](img/sezione6/sprintBacklog.png)
...
- suddividere gli elementi del [[Product Backlog|product backlog]] in attività;
- completare la pianificazione dello [[Sprint|sprint]] in circa quattro-otto ore;
- [[Sprint|sprint]] di una settimana non dovrebbe richiedere più di un paio d'ore pianificare (o anche meno).

### [[Sprint]] Execution
Dopo la pianificazione dello [[Sprint|sprint]], il team di sviluppo, guidato dall'aiuto dello Scrum Master, esegue tutto il lavoro a livello di attività necessario per **completare** le funzionalità.

*Completato* significa che c'è un alto grado di [[Sicurezza|sicurezza]], che tutto il lavoro necessario per produrre caratteristiche di buona qualità sia stato completato.
Nessuno dice al team di sviluppo in quale ordine o come eseguire il lavoro a livello di attività nello [[Sprint|sprint]] backlog.

Invece, i membri del team definiscono il proprio lavoro a livello di attività e quindi si auto-organizzano in qualsiasi modo ritengano sia migliore per raggiungere l'obiettivo dello [[Sprint|sprint]].

### Daily Scrum
Ogni giorno dello [[Sprint|sprint]], idealmente alla stessa ora, i membri del team di sviluppo tengono una riunione giornaliera (15 minuti o meno) dove si pongono le seguenti domande:
...
### Stato "Completato"
Lo [[Sprint|sprint]] risulta come un incremento di **prodotto potenzialmente consegnabile**: il team SCRUM definisce una definizione di *completato*.

Potenzialmente consegnabile è uno stato di fiducia che verifica ciò che è stato costruito nello [[Sprint|sprint]] è effettivamente fatto, il che significa che non c'è un lavoro non svolto di importanza materiale e possiamo fornire i risultati desiderati dal business.
...
La *[[Sprint|sprint]] review* è un momento per ispezionare e adattare il prodotto. La **[[Sprint|sprint]] retrospective** è un'opportunità per ispezionare e adattare il processo: il team di sviluppo, ScrumMaster e il proprietario si riuniscono per discutere cosa sta e non sta lavorando con SCRUM e le pratiche tecniche associate.
