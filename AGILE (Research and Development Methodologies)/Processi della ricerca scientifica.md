...
Da un bando, puoi creare una proposta di progetto o fare ricerca e sviluppo (sull'applicazione di ricerche da parte delle aziende). I tipi di bando per la ricerca pura sono:
- **ERC** (importante ricerca su qualcosa che può cambiare ogni vita);
- **PRIN** (progetti di interesse nazionale).

Il **pacchetto di lavoro (work package)** descrive cosa farai, campo e attività. Ha:
- un output, come un software;
- numero di ore trascorse;
- distribuzione dello sforzo;
- chi, come e da quale organizzazione.

*Cosa vuoi fare? Chi vuole farlo? Perchè farlo?* Per un serie di fattori:
- pacchetto di lavoro;
- attività;
- sottoattività;
- obiettivi, tempi, costi;
- consegne;
