...
![](img/sezione13/sprintPlanning1.png)

Possiamo identificare **diversi livelli di pianificazione**: 
- **Portfolio Planning:** si identificano i backlog-items che si devono realizzare nel corso di questo [[Sprint|sprint]]. Non necessariamente devono essere nuovi prodotti, potrebbero essere anche delle revisioni dei processi in corso;
- **Product Planning:** si va a definire la visione del prodotto e cioè si definisce l'area di interesse degli stakeholder. Si va quindi a definire una *roadmap* dei prodotti che dovranno essere realizzati nelle successive release.
    ![](img/sezione13/sprintPlanning2.png)
...
- **fixed scope burnup chart:** un grafico di burnup per una versione con ambito fisso mostra la quantità totale di lavoro in una versione come obiettivo o linea di destinazione e i nostri progressi;
    ...
    ![](img/sezione13/sprintPlanning3.png)
    
- **fixed scope burnout chart:** il nostro obiettivo è comunicare la gamma di funzionalità che prevediamo di completare e il nostro progresso [[Sprint|sprint]] per [[Sprint|sprint]]. Mostra la quantità totale di lavoro incompiuto che rimane in ogni [[Sprint|sprint]];
    
    ![](img/sezione13/sprintPlanning4.png)
...
- **[[Product Backlog|Product backlog]]:** prima della pianificazione dello [[Sprint|sprint]], gli elementi del [[Product Backlog|product backlog]] più in alto sono stati portati in uno stato pronto;
- **Velocità del team:** la velocità storica del team è un indicatore di quanto lavoro è pratico per il team completare in uno [[Sprint|sprint]];
...
- **Capacità del team:** le capacità tengono conto delle persone che fanno parte del team, delle capacità di ciascun membro del team e della disponibilità di ciascuna persona nel prossimo [[Sprint|sprint]];
- **Obiettivo dello [[Sprint|sprint]] iniziale:** questo è l'obiettivo aziendale che il product owner vorrebbe vedere raggiunto durante lo [[Sprint|sprint]].

Ci sono due approcci allo [[Sprint|sprint]] planning:
...
Quando si vuole determinare la capacità devono essere prese in considerazione numerose variabili: il tempo personale del team, il lavoro al di fuori dello [[Sprint|sprint]] e il lavoro di altri progetti.

Pertanto, conviene sempre lasciare un certo margine di errore (**"buffer"**). Viene misurato in *story points* e *effort hours*.

![](img/sezione13/sprintBacklog.png)
