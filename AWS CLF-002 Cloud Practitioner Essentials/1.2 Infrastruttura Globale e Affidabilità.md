...
*   **AWS Software Development Kits (SDK)**: librerie che permettono di interagire con AWS tramite diversi linguaggi di programmazione (Python, Java, [[3.1 JavaScript|JavaScript]], ecc.). Consentono di integrare direttamente i servizi cloud nelle applicazioni, semplificando lo sviluppo di soluzioni cloud-native automatizzate e personalizzate.
