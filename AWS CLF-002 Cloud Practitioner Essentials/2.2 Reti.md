...
Le **sottoreti** suddividono la VPC in segmenti più piccoli, permettendo di separare le risorse pubbliche da quelle private. In base alla sottorete in cui collochi una risorsa, puoi decidere se renderla accessibile da Internet (ad esempio un sito web) oppure solo da una rete privata interna (come un [[2.4 Database|database]] aziendale).
...
In questo modo, sia le ACL che i Security Group lavorano insieme per garantire [[3.1 Sicurezza|sicurezza]] e controllo del traffico.
