---
aliases: [CGCA, "Monitoraggio, Conformità Governance Cloud AWS"]
tags: [aws-clf-002-cloud-practitioner-essentials]
---
## Importanza del monitoraggio

Il **monitoraggio delle risorse cloud** è importante. Permette di osservare e analizzare continuamente l'attività del sistema, il traffico di rete e gli [[Eventi|eventi]] di [[Sicurezza|sicurezza]] per rilevare potenziali minacce o anomalie. Il monitoraggio e l'osservabilità sono componenti essenziali per garantire la [[Sicurezza|sicurezza]], la disponibilità, l'affidabilità e le prestazioni dei carichi di lavoro e dei dati nel cloud.
...
*   **Dashboard CloudWatch**: permettono di creare [[Viste|viste]] personalizzate per monitorare più risorse in un’unica interfaccia.
...
In un ambiente cloud ibrido, le organizzazioni devono poter sapere chi ha effettuato modifiche, quando e su quali risorse, sia nel cloud che on-premises. Questo è essenziale per risolvere problemi operativi, garantire la conformità e mantenere un elevato livello di [[Sicurezza|sicurezza]].
...
*   **Verifica e conformità**: fornisce prove documentate delle attività per soddisfare gli audit e le normative di [[Sicurezza|sicurezza]].
*   **Monitoraggio della [[Sicurezza|sicurezza]]**: consente di identificare azioni sospette o non autorizzare sugli account e sulle risorse.
*   **Risoluzione dei problemi**: aiuta a diagnosticare [[Eventi|eventi]] operativi analizzando chi ha eseguito determinate operazioni e in quali circostanze.
...
**AWS Artifact** è un servizio gratuito che fornisce accesso on-demand ai report AWS di [[Sicurezza|sicurezza]] e conformità e ad alcuni accordi online selezionati. È una piattaforma centrale che consente di gestire la conformità in modo trasparente, eliminando la necessità di richiedere manualmente i documenti a AWS.
...
*   **Report di AWS Artifact**: forniscono documenti di conformità verificati da revisori di terze parti. Questi report attestano che AWS ha superato verifiche indipendenti relative a standard di [[Sicurezza|sicurezza]] e privacy a livello globale, regionale e settoriale (es. ISO 27001, SOC 2, PCI DSS, ecc.).
...
*   **Whitepaper e guide di [[Sicurezza|sicurezza]]**: includono risposte alle domande più frequenti, panoramiche sui rischi e checklist per la verifica.
...
La maggior parte delle aziende adotta linee guida di configurazione specifiche per garantire [[Sicurezza|sicurezza]], efficienza e conformità normativa. Tuttavia, poiché le risorse AWS possono essere create e modificate rapidamente, è essenziale disporre di strumenti che permettano di valutare e monitorare automaticamente le configurazioni, verificando che rispettino le policy aziendali.
...
*   Collaborazione semplificata tra team di [[Sicurezza|sicurezza]], conformità e audit.
...
*   **Maggiore controllo e [[Sicurezza|sicurezza]]**: puoi assegnare permessi e risorse condivise in modo coerente tra gli account.

Si utilizza AWS Organizations per automatizzare la creazione di account per nuovi reparti, team o clienti, gestire in modo centralizzato le policy di [[Sicurezza|sicurezza]] e accesso, controllare l’utilizzo dei servizi AWS per evitare errori o violazioni di policy e condividere risorse comuni, come VPC, Route53 o licenze, tra più account.
...
Quando pianifichi la tua organizzazione, considera i requisiti di [[Sicurezza|sicurezza]], governance e conformità di ogni reparto, raggruppa i team o i progetti con obiettivi simili in unità organizzative (UO) e applica policy mirate a ogni livello (root, UO, account).
...
La **Dashboard AWS Health** serve a visualizzare informazioni sull'integrità specifiche dell'account e ottenere aggiornamenti sugli [[Eventi|eventi]] in AWS Health. Puoi anche utilizzare AWS Health a livello di programmazione utilizzando l'API AWS Health, disponibile con Supporto AWS Premium.

Il vantaggio è che la Dashboard AWS Health fornisce informazioni preziose come origine dati per [[Eventi|eventi]] e modifiche. Offre indicazioni tempestive e di utilità pratica per risolvere i problemi. Inoltre, aiuta a gestire l'integrità dei servizi ed è integrata e automatizzata per l'utilizzo su larga scala.
