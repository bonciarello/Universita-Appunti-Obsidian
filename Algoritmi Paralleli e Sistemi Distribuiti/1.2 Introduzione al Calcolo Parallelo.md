...
## [[3.3 Architettura|Architettura]] parallela generica
...
- **basato sulla tipologia di rete di interconnessione**: bus, traversa, [[0.00 Reti|reti]] dirette e indirette
...
Come viene utilizzato? Come un computer parallelo (MPI, [[3.1 OpenMP|OpenMP]], PVM), come un mucchio di CPU e come multiprocessore virtuale (Mosix).
...
- **[[3.1 OpenMP|OpenMP]]:** gestisce la distribuzione del processo e dei dati nelle macchine SMP, le comunicazioni avvengono tramite memoria condivisa;
...
- **PARALLEL OVERHEAD** è il tempo impiegato per coordinare attività parallele, in contrasto con il lavoro utile. I fattori determinanti sono:
    ...
    4. overhead software imposto da compilatori paralleli, librerie, strumenti, [[0.00 Sistemi Operativi|sistemi operativi]], ecc.
