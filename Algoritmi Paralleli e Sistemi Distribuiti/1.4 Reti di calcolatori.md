...
---
## [[0.00 Reti|Reti]] di interconnessione per computer paralleli

**Le [[0.00 Reti|reti]] di interconnessione trasportano i dati tra il processore e la memoria.** Le interconnessioni sono realizzate tramite **switch** e **link** (fili, fibra). Le interconnessioni sono classificate come **statiche** o **dinamiche**:

- Le **[[0.00 Reti|reti]] statiche** sono costituite da comunicazioni punto a punto tra i nodi e sono denominate [[0.00 Reti|reti]] dirette;
- Le **[[0.00 Reti|reti]] dinamiche** vengono implementate utilizzando interruttori e collegamenti di comunicazione. Sono anche chiamate [[0.00 Reti|reti]] **indirette**.

![[staticheEdinamiche.png]]

## Metricle per la valutazione delle [[0.00 Reti|reti]]

- **Diametro:** distanza massima tra 2 nodi (**meglio diametri piccoli**)
- **Connettività:** numero minimo di archi che devono essere rimossi per dividere la rete in 2 [[0.00 Reti|reti]] disconnesse (**migliore connettività alta**)
...
### Topologie di rete: [[0.00 Reti|reti]] multistadio

Le **barre trasversali (crossbars)** hanno eccellenti prestazioni di scalabilità ma scarsa scalabilità dei costi. I **bus (buses)** hanno un'eccellente scalabilità dei costi ma una ridotta scalabilità delle prestazioni. **Le [[0.00 Reti|reti]] multistadio cercano un equilibrio tra i due.**

![[reteMultistadio.png]]

### Topologie di rete: [[0.00 Reti|reti]] multistadio Omega

Una delle [[0.00 Reti|reti]] multistadio più conosciute è la rete **OMEGA**. Questa rete è costituita da *log p* passi, dove p è il numero di ingressi/uscite. In ogni fase, l'ingresso *i* è collegato all'uscita *j* se (**left_rotation**):
...
### Topologie di rete: [[0.00 Reti|reti]] multistadio Omega - Routing
...
## [[0.00 Reti|Reti]] statiche

### Topologie di rete: [[0.00 Reti|reti]] completamente interconnesse

**Ogni** processore è collegato a ogni altro processore. Il numero di collegamenti nella rete scala come $O(p^2)$. Sebbene la scalabilità delle prestazioni sia molto buona, la **complessità hardware** non è fattibile per valori **elevati** di *p*. In questo senso, queste [[0.00 Reti|reti]] sono la **controparte statica** della traversa.

### Topologie di rete: [[0.00 Reti|reti]] a stella

Ogni nodo è connesso a un nodo "centrale" comune. La distanza tra due nodi qualsiasi è $O(1)$. Tuttavia, il nodo centrale può diventare un **collo di bottiglia**. In questo senso, le [[0.00 Reti|reti]] a stella sono **controparti statiche** delle [[0.00 Reti|reti]] bus.
...
### Topologie di rete: [[0.00 Reti|reti]] ad albero

![[reteAlbero.png]]

[[0.00 Reti|Reti]] ad albero binario completi: (a) una rete ad albero statico; e (b) una rete dinamica libera.
...
## Valutazione delle [[0.00 Reti|reti]] di interconnessione statica

![[valutazioneStatica.png]]

## Valutazione delle [[0.00 Reti|reti]] di interconnessione dinamica
...
## Meccanismi di instradamento per [[0.00 Reti|reti]] di comunicazione
