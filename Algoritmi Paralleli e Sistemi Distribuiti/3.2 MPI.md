...
- **Le posizioni di memoria utilizzate per il trasferimento dei messaggi possono essere utilizzate in [[3.1 Sicurezza|sicurezza]]:**
...
## Topologie delle [[0.00 Reti|reti]]: ipercubi e loro costruzione
...
**ESEMPIO:** se hai bisogno di una topologia in cui ogni processo comunichi con i suoi vicini lungo xey, e l'[[3.3 Architettura|architettura]] della macchina parallela per la comunicazione reale è quella dell'ipercubo, la mappatura della figura (d) risulta essere la migliore.
