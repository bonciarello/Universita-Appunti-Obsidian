...
## [[5.1 Sorting|Sorting]] in parallelo: esempio generale
...
- **Fase 1 ([[5.1 Sorting|sorting]] locale):** ogni processore ordina il proprio vettore con un algoritmo di ordinamento standard (ad esempio, quicksort);
...
Procediamo con la *fase 1 ([[5.1 Sorting|sorting]] locale)* dove ogni processore ordina in modo **crescente** la propria **sottolista**.
