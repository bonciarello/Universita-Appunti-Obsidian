...
- **[[3.1 Alberi binari|Alberi binari]] di ricerca** ⇒
...
- **Merge Sort**: è una classica applicazione della tecnica *[[2.3 Divide et impera|divide et impera]]*. Dato un vettore di *n* elementi si suddivide in due parti. A questo punto si ordinano ricorsivamente i due vettori e quindi il vettore complessivo viene ordinato per "fusione" dei due sotto-vettori.
```cpp
