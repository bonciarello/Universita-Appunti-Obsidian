...
---
Un problema di base nei [[3.3 Grafi|grafi]] è visitare tutti i nodi raggiungibili da un dato nodo *v*, cioè determinare tutti i nodi *w* per cui esiste un cammino da *v* a *w*.
