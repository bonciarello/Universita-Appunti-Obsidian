...
- **ALTRI APPROCCI?**
  - Variazione del problema **[[5.4 Subset sum|subset sum]]** (dato un insieme I di numeri positivi e una soglia T, stabilire se esiste un sottoinsieme *I'* tale che sum(I') ≤ T e sia la più grande possibile);
