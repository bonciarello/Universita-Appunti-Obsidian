...
Un altro operatore fondamentale dell’[[3.1 Algebra relazionale|algebra relazionale]] è il join. Ricordiamo che si tratta di un operatore commutativo, cioè, $ R \bowtie S \equiv S \bowtie R $.
...
## Fasi e step del progetto
    ...
    - definizione dello schema della base di dati sul DBMS relazionale open-source [[4.3 MySQL|MySQL]] mediante SQL-DDL;
...
## Modelli dei dati adottati
    ...
    - *DDL:* SQL supportato dal DBMS scelto ([[4.3 MySQL|MySql]])

## SQL

Originariamente acronimo di *"Structured Query Language"*, ora nome proprio. È uno standard (1986, poi 1989, 1992, 1999 e infine 2003) ma esistono varie versioni (DBMS diversi implementano versioni diverse). È un linguaggio **dichiarativo** (a differenza dell’[[3.1 Algebra relazionale|algebra relazionale]] che è di tipo procedurale).
