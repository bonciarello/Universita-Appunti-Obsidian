...
Per quanto riguarda le metodologie di progettazione, essendo che le [[0.00 Basi di Dati|basi di dati]] sono sempre più complesse e sofisticate, è necessario un approccio sistematico.
...
- [[2.1 Progettazione concettuale|progettazione concettuale]];
- progettazione logica;
- [[2.4 Progettazione fisica|progettazione fisica]].
...
## Progettazione logica
È la traduzione dello schema concettuale nel modello dei dati del DBMS. Il risultato sarebbe lo schema logico nel DDL del DBMS. Gli aspetti considerati durante la progettazione logica sarebbero integrità e consistenza, [[3.1 Sicurezza|sicurezza]] ed efficienza.
