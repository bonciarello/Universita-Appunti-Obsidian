...
Il 16 gennaio 2008 **Sun Microsystems** ha acquistato la società per un miliardo di dollari, stimando il mercato del [[2.4 Database|database]] in 15 miliardi di dollari.
...
Nel caso dei DBMS, tutto lo scambio di dati con il demone avrà come scopo la gestione dei [[2.4 Database|database]].
