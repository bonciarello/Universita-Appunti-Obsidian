...
Formula base: $V = K + A$
(Valore Asset + Flussi di reddito eccedenti).

**EVA (Economic Value Added):**
Misura la creazione di valore oltre il costo del capitale.
...
Valuta la redditività attualizzando i flussi futuri.
...
Metodo standard per valutare un'azienda intera.
