...
Immagina un'applicazione di shopping che carica immagini tramite [[2.1 HTML|HTML]]:
...
Il modo più efficace è evitare del tutto di passare l'input fornito dall'utente alle API del [[3.2 File System|file system]].
...
2.  **Canonizzazione:** Usa l'API del [[3.2 File System|file system]] per canonizzare il percorso (risolvere i `../`) e verifica che inizi con la directory base prevista.
