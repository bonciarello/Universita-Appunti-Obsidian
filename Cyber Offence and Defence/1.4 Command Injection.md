...
Puoi reindirizzare l'output del comando iniettato in un file all'interno della radice web che puoi quindi recuperare tramite il browser. Ad esempio, se l'applicazione serve risorse statiche dalla posizione del [[3.2 File System|file system]] `/var/www/static`, puoi inviare il seguente input:
