...
*   **Dettagli tecnici:** Versioni dei software, nomi di [[2.4 Database|database]], percorsi di file, configurazioni di rete.

## Cause comuni
1.  **Impossibilità di rimuovere contenuti interni:** Commenti degli sviluppatori lasciati nel codice [[2.1 HTML|HTML]] o file di backup accessibili.
...
Possono rivelare:
*   Tecnologie utilizzate (motori di template, tipi di [[2.4 Database|database]]).
...
Commenti [[2.1 HTML|HTML]] che potrebbero contenere directory nascoste o indizi sulla logica applicativa.
...
*   **Controllo configurazioni:** Verificare le impostazioni di [[3.1 Sicurezza|sicurezza]] di tutte le tecnologie di terze parti integrate.