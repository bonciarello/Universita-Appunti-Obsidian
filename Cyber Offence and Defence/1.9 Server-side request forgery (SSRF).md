...
---
La falsificazione delle richieste lato server (SSRF, Server-side request forgery) è una vulnerabilità della [[3.1 Sicurezza|sicurezza]] web che consente a un aggressore di indurre l'applicazione lato server a inviare richieste a una posizione non desiderata.
