...
Una comune protezione lato client attuata tramite il browser web è quella di utilizzare script di frame busting o frame breaking. Questi possono essere implementati tramite componenti aggiuntivi o estensioni [[3.1 JavaScript|JavaScript]] proprietari del browser come NoScript.
...
Le tecniche di frame busting sono spesso specifiche del browser e della piattaforma e, grazie alla flessibilità dell'[[2.1 HTML|HTML]], possono solitamente essere aggirate dagli aggressori. Poiché i frame buster sono [[3.1 JavaScript|JavaScript]], le impostazioni di [[3.1 Sicurezza|sicurezza]] del browser potrebbero impedirne il funzionamento o addirittura il browser potrebbe non supportare [[3.1 JavaScript|JavaScript]].
