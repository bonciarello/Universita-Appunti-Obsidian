...
Header e Payload sono oggetti JSON codificati in Base64Url. Possono essere facilmente decodificati e letti da chiunque. La [[3.1 Sicurezza|sicurezza]] dipende interamente dalla **Firma**.
## Attacchi JWT
...
- **kid (Key ID):** identifica quale chiave usare.
    ...
    - **SQL Injection:** Se il `kid` è usato in una query [[2.4 Database|database]], potrebbe essere vettore di SQLi.
