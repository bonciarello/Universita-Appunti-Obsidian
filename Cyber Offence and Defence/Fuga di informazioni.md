...
*   **Dettagli tecnici:** Versioni dei software, nomi di [[Database|database]], percorsi di file, configurazioni di rete.
...
Possono rivelare:
*   Tecnologie utilizzate (motori di template, tipi di [[Database|database]]).
...
*   **Controllo configurazioni:** Verificare le impostazioni di [[Sicurezza|sicurezza]] di tutte le tecnologie di terze parti integrate.