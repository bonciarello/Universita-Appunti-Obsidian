...
tags: [deep-learning]
---
Negli ultimi anni, l'**Intelligenza Artificiale (AI)** è stata oggetto di un intenso clamore mediatico. L'**Apprendimento Automatico ([[0.00 Machine Learning|Machine Learning]])**, l'**Apprendimento Profondo ([[0.00 Deep Learning|Deep Learning]])** e l'intelligenza artificiale compaiono in innumerevoli articoli, spesso al di fuori delle pubblicazioni orientate alla tecnologia.

Prima dobbiamo definire chiaramente di cosa parliamo quando ci riferiamo all'intelligenza artificiale. Cosa sono l'intelligenza artificiale, il [[0.00 Machine Learning|machine learning]] e il [[0.00 Deep Learning|deep learning]]? Come si relazionano tra loro?

## Intelligenza Artificiale (AI)

L'**Intelligenza Artificiale (AI)** è emersa negli anni '50, quando i pionieri dell'informatica si sono chiesti se i computer potessero pensare. Questo campo cerca di automatizzare compiti intellettuali umani e comprende il [[0.00 Machine Learning|machine learning]], il [[0.00 Deep Learning|deep learning]] e altri approcci.
...
## Apprendimento Automatico (ML, [[0.00 Machine Learning|Machine Learning]])
...
L'ML ha guadagnato popolarità negli anni '90 grazie all'aumento della potenza di calcolo e dei dati disponibili. Si differenzia dalla statistica tradizionale in quanto gestisce set di dati grandi e complessi, rendendo l'analisi statistica classica poco pratica. Di conseguenza, l'apprendimento automatico (tra cui il [[0.00 Deep Learning|Deep Learning]]) si basa più sull'ingegneria che sulla teoria matematica e si dimostra spesso empiricamente anziché teoricamente.

## Apprendimento Profondo (DL, [[0.00 Deep Learning|Deep Learning]])

L'**Apprendimento Profondo (DL)** è una sottocategoria del ML che utilizza **[[0.00 Reti|reti]] neurali artificiali profonde** per apprendere e risolvere problemi complessi. Queste [[0.00 Reti|reti]] neurali sono ispirate al funzionamento del cervello umano e sono composte da numerosi strati di neuroni artificiali, da cui il termine "profondo".

In breve, il DL è caratterizzato da:

*   **[[0.00 Reti|Reti]] neurali profonde:** Hanno molti strati intermedi (noti come strati nascosti) tra l'input e l'output. Questi strati intermedi consentono al modello di apprendere rappresentazioni sempre più complesse dei dati.
...
In sintesi, il DL è una tecnologia di apprendimento automatico che utilizza [[0.00 Reti|reti]] neurali profonde per apprendere automaticamente rappresentazioni complesse dai dati, ed è diventato una delle tecnologie chiave nell'intelligenza artificiale.