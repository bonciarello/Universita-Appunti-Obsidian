...
---
## Framework Keras
**Keras** è un framework di [[0.00 Deep Learning|deep learning]] per Python che consente una sperimentazione rapida.
*   Esegue codice su CPU o GPU.
*   API intuitiva per prototipazione rapida.
*   Supporto per [[0.00 Reti|reti]] convoluzionali (CNN) e ricorrenti (RNN).
