...
In [[0.00 Deep Learning|deep learning]], il numero di parametri è spesso chiamato "capacità" del modello. Intuitivamente:
...
Un "modello semplice" in questo contesto è un modello in cui la distribuzione dei valori dei pesi ha un'[[3.3 Entropia|entropia]] bassa (o che ha meno parametri).
