...
## [[0.00 Reti|Reti]] Neurali con TensorFlow

**TensorFlow (TF)** è una piattaforma open-source end-to-end per il [[0.00 Machine Learning|machine learning]] sviluppata da Google.
...
2.  **Definizione del Modello:** Creare l'[[3.3 Architettura|architettura]] della rete (es. usando `Sequential`).
