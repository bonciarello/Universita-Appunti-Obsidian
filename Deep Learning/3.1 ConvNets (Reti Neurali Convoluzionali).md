...
tags: [deep-learning]
---
Le **ConvNets** (o CNN) sono un tipo di [[3.3 Architettura|architettura]] di rete neurale progettata specificamente per elaborare dati che hanno una struttura a griglia, come immagini (griglia 2D di pixel) o serie temporali (griglia 1D).
Sono state fondamentali per la rivoluzione del [[0.00 Deep Learning|Deep Learning]] nella Computer Vision, alimentando applicazioni come il riconoscimento facciale, le auto a guida autonoma e la diagnostica medica.

## Differenza Fondamentale con le [[0.00 Reti|Reti]] Dense
Nelle [[0.00 Reti|reti]] densamente connesse (Dense/Fully Connected), ogni neurone è collegato a tutti i neuroni dello strato precedente. Queste [[0.00 Reti|reti]] apprendono **pattern globali** nel loro spazio di input.
...
Per mantenere le stesse dimensioni spaziali (spesso utile per costruire [[0.00 Reti|reti]] profonde), usiamo il **Padding**: aggiungiamo righe e colonne di zeri attorno all'input.
...
## Esempio di [[3.3 Architettura|Architettura]] Completa (CIFAR-10)
