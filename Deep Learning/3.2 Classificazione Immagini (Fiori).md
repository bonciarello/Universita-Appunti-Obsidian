...
Le immagini RGB hanno valori dei pixel nel range [0, 255]. Le [[0.00 Reti|reti]] neurali convergono molto più velocemente se gli input sono piccoli e normalizzati, tipicamente nel range [0, 1].
