...
tags: [deep-learning]
---
Le [[0.00 Reti|reti]] neurali [[3.4 Viste|viste]] finora (Dense, ConvNets) sono **Feedforward**: non hanno memoria. Elaborano ogni input indipendentemente dagli altri. Se mostriamo loro una scena di un film, non capiscono cosa è successo nella scena precedente.
Le **[[0.00 Reti|Reti]] Neurali Ricorrenti (RNN)** affrontano questo limite: sono [[0.00 Reti|reti]] con un "loop", progettate per elaborare sequenze (testo, audio, serie temporali finanziarie, video).
...
Le SimpleRNN teoricamente possono ricordare informazioni [[3.4 Viste|viste]] molto tempo fa. In pratica, però, falliscono su sequenze lunghe. Perché?
...
Grazie a questa struttura, il gradiente può fluire inalterato per molti passi temporali, permettendo alla rete di ricordare [[2.4 Eventi|eventi]] accaduti molto prima.
