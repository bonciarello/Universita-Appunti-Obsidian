...
tags: [deep-learning]
---
Le [[0.00 Reti|Reti]] Neurali Ricorrenti (RNN) sono l'[[3.3 Architettura|architettura]] d'elezione per elaborare dati sequenziali come il testo. A differenza delle immagini (dove i pixel vicini sono correlati spazialmente), nel testo le parole hanno significato solo nel contesto della frase che le precede (e le segue).
...
Le [[0.00 Reti|reti]] neurali non capiscono le stringhe. Dobbiamo convertire il testo in numeri.
...
### 2. Padding
Le [[0.00 Reti|reti]] neurali richiedono input di dimensione fissa (tensori rettangolari). Ma le frasi hanno lunghezze diverse.
