...
tags: [deep-learning]
---
Il modello **Seq2Seq** (o Encoder-Decoder) è l'[[3.3 Architettura|architettura]] che ha reso possibile la moderna traduzione automatica (Google Translate pre-2016), i chatbot e il riassunto automatico di testi.
...
## [[3.3 Architettura|Architettura]] Base
...
Il problema dell'[[3.3 Architettura|architettura]] base è che il Vettore di Contesto deve contenere *tutte* le informazioni della frase. Se la frase è molto lunga (es. 50 parole), è impossibile comprimerla in un vettore di dimensione fissa (es. 256 numeri) senza perdere dettagli. Questo è il collo di bottiglia.
