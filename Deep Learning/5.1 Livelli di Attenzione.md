...
Immaginiamo di avere un [[2.4 Database|database]] di coppie (Chiave, Valore). Arriva una Query.
*   In un [[2.4 Database|database]] classico, cerchiamo la Chiave esatta e restituiamo il Valore.
