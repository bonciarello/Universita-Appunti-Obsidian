...
Le [[0.00 Reti|reti]] dense perdono l'informazione spaziale (struttura 2D). Per le immagini, le **Convolutional Neural Networks (CNN)** sono molto più potenti.
...
### [[3.3 Architettura|Architettura]] Convoluzionale
