...
3. **[[2.2 Polimorfismo|Polimorfismo]]:** Permette di attivare a tempo di esecuzione comportamenti diversi su oggetti con un'interfaccia comune.
...
```
## [[2.2 Gestione della memoria|Gestione della Memoria]] nelle Classi (Esempio `VectorOfInt`)
