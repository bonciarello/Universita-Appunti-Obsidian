...
- **[[0.00 Ingegneria del Software|Ingegneria del Software]] basata sui componenti:** il sistema è assemblato da componenti esistenti.
...
- per parti di sistemi di grandi dimensioni (es. l'[[2.1 Interfaccia utente|interfaccia utente]]);
- per sistemi di breve durata.

### [[0.00 Ingegneria del Software|Ingegneria del Software]] basata sui componenti
...
### [[6.1 Evoluzione del software|Evoluzione del software]]
...
CASE è un software per supportare i processi di sviluppo e di [[6.1 Evoluzione del software|evoluzione del software]]. Si occupa dell'automazione delle attività come:

- editor grafici per lo sviluppo di modelli di sistema;
- dizionario dati per la gestione delle entità progettuali;
- generatore di [[2.1 Interfaccia utente|interfaccia utente]] grafica per la costruzione dell'[[2.1 Interfaccia utente|interfaccia utente]];
