...
- [[0.00 Ingegneria del Software|Ingegneria del software]] basata sul riutilizzo;
- [[0.00 Ingegneria del Software|Ingegneria del software]] basata su componenti.
...
- nei processi di progettazione per esplorare le opzioni e sviluppare un design dell'[[2.1 Interfaccia utente|interfaccia utente]];
...
I RAD sono progettati per sviluppare applicazioni aziendali ad alta intensità di dati e si basano sulla programmazione e sulla presentazione di informazioni da un [[2.4 Database|database]]. 

Alcuni tools sono: linguaggio di programmazione del [[2.4 Database|database]], generatore di interfaccia, collegamenti ad applicazioni per ufficio e generatori di rapporti.
...
- un [[2.4 Database|database]] per memorizzare i requisiti;
