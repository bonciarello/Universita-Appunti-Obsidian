...
| *Robustezza* | È ora di riavviare dopo un errore<br>Percentuale di [[2.4 Eventi|eventi]] che causano guasti<br>Probabilità di danneggiamento dei dati in caso di errore |
...
- un'[[3.3 Architettura|architettura]] di sistema può essere progettata per strutturare i requisiti;
...
- *punti di vista dell'interattore:* persone o altri sistemi che interagiscono direttamente con il sistema (per esempio, in un bancomat, il [[2.4 Database|database]] del cliente e del conto sono interagenti);
- *punti di vista indiretti:* stakeholder che non utilizzano il sistema da soli ma che influenzano i requisiti (per esempio, in un ATM, il personale di gestione e di [[3.1 Sicurezza|sicurezza]] sono punti di vista indiretti);
...
- una descrizione del normale flusso degli [[2.4 Eventi|eventi]];
...
## [[2.2 Casi d'uso|Casi d'uso]]

I [[2.2 Casi d'uso|casi d'uso]] sono una tecnica basata su scenari in UML che identifica gli attori in un'interazione e che descrivono l'interazione stessa.

Una serie di [[2.2 Casi d'uso|casi d'uso]] dovrebbe descrivere tutte le possibili interazioni con il sistema.

I diagrammi di sequenza possono essere utilizzati per aggiungere dettagli ai [[2.2 Casi d'uso|casi d'uso]] mostrando la sequenza di elaborazione degli [[2.4 Eventi|eventi]] nel sistema.
...
- *prospettiva strutturale* che mostra il sistema o l'[[3.3 Architettura|architettura]] dei dati.
...
- *modello stimolo/risposta* che mostra la reazione del sistema agli [[2.4 Eventi|eventi]].
...
- *modelli di macchine a stati* che mostrano la risposta dei sistemi agli [[2.4 Eventi|eventi]].
...
**Questi modelli modellano il comportamento del sistema in risposta a [[2.4 Eventi|eventi]] esterni e interni.**

**Mostrano le risposte del sistema agli stimoli**, quindi sono spesso usati per modellare i sistemi in tempo reale.

I modelli di macchine a stati mostrano gli stati del sistema come nodi e gli [[2.4 Eventi|eventi]] come archi tra questi nodi. Quando si verifica un evento, il sistema si sposta da uno stato all'altro.
...
Ampiamente utilizzato nella progettazione di [[2.4 Database|database]]. Può essere facilmente implementato utilizzando [[2.4 Database|database]] relazionali.
...
- [[3.3 Architettura|Architettura]] del sistema
- Specifica dei requisiti di sistema
- Modelli di sistema
...
- altre tecniche di [[0.00 Ingegneria del Software|ingegneria del software]] hanno avuto successo;
