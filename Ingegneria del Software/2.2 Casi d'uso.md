...
- **Requisiti speciali:** 
    - [[2.1 Interfaccia utente|Interfaccia utente]] di tipo touch screen su un monitor piatto grande. Il testo deve essere visibile da una distanza di un metro;
...
- *Chi si occupa della gestione degli utenti e della [[3.1 Sicurezza|sicurezza]]?*
- *Il "tempo" è un attore, nel senso che il sistema esegue operazioni in risposta ad alcuni [[2.4 Eventi|eventi]] temporali?*
...
> **Linea guida:** scrivere i casi d'uso in uno stile essenziale; ignorare l'[[2.1 Interfaccia utente|interfaccia utente]], concentrarsi sullo scopo dll'attore.
