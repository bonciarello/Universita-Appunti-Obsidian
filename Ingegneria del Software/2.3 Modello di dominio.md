...
- **Ruoli di persone o organizzazioni correlati alle transazioni; attori nei [[2.2 Casi d'uso|casi d'uso]]:** normalmente dobbiamo sapere quali sono le parti coinvolte in una transazione (ad es. *Cashier, Customer, Store MonopolyPlayer Passenger, Airline*);
- **Luogo della transazione; luogo del servizio** (ad es. *Store Airport, Plane, Seat*);
- **[[2.4 Eventi|Eventi]] significativi, spesso con un'ora o un luogo che è necessario ricordare** (ad es. *Sale, Payment MonopolyGame Flight*);
...
Nondimeno, l'analisi linguistica è un'altra fonte di ispirazione. I [[2.2 Casi d'uso|casi d'uso]] in formato dettagliato sono un'ottima descrizione a cui ispirarsi per questa analisi. Per esempio, si può riutilizzare lo scenario corrente del caso d'uso *Process Sale*.
