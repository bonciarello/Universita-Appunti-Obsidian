...
- **Riferimenti:** [[2.2 Casi d'uso|casi d'uso]] in cui può verificarsi questa operazione;
...
> **Definizione:** le **post-condizioni** descrivono i cambiamenti nello stato degli oggetti nel [[2.3 Modello di dominio|modello di dominio]]. I cambiamenti di stato nel [[2.3 Modello di dominio|modello di dominio]] comprendono le istanze create, le associazioni formate o rotte e gli attributi modificati.

***Le post-condizioni non sono azioni da eseguire nel corso dell'operazione;*** si tratta piuttosto di *osservazioni* (rilevazioni) sugli oggetti del [[2.3 Modello di dominio|modello di dominio]] che risultano avere al termine dell'operazione.
...
### Le post-condizioni sono correlate al [[2.3 Modello di dominio|modello di dominio]]

Queste post-condizioni sono espresse nel contesto degli oggetti del [[2.3 Modello di dominio|Modello di Dominio]]. Quali istanze si possono creare? Quelle del [[2.3 Modello di dominio|Modello di Dominio]]. Quali associazioni di possono formare? Quelle del [[2.3 Modello di dominio|Modello di Dominio]], e così via.
...
2. Creare un contratto per le operazioni di sistema complesse o i cui effetti sono probabilmente sottili, o che non sono chiare dai [[2.2 Casi d'uso|casi d'uso]];
...
- **Riferimenti:** [[2.2 Casi d'uso|casi d'uso]]: Process Sale;
