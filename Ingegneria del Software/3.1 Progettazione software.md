...
## [[3.3 Architettura|Architettura]] software
...
Una descrizione dell'[[3.3 Architettura|architettura]] software è l'output di questo processo di progettazione.
...
## Vantaggi dell'[[3.3 Architettura|architettura]] esplicita

- **Comunicazione agli stakeholder:** l'[[3.3 Architettura|architettura]] può essere utilizzata come fulcro di discussione da parte degli stakeholder del sistema;
- **Analisi del sistema:** significa che è possibile analizzare se il sistema può soddisfare i suoi requisiti non funzionali;
- **Riutilizzo su larga scala:** l'[[3.3 Architettura|architettura]] può essere riutilizzabile in una vasta gamma di sistemi.

## [[3.3 Architettura|Architettura]] e caratteristiche del sistema

L'[[3.3 Architettura|architettura]] consente di localizzare le operazioni critiche:
...
- **Protezione:** utilizzare un'[[3.3 Architettura|architettura]] a più livelli con risorse critiche nei livelli interni;
- **[[3.1 Sicurezza|Sicurezza]]:** localizzare le funzioni critiche per la [[3.1 Sicurezza|sicurezza]] in un numero limitato di sottosistemi;
...
Quando andiamo a fare la progettazione dell'[[3.3 Architettura|architettura]], dobbiamo porci diverse domande: come sarà distribuito il sistema? Quali stili architettonici sono appropriati? Quale strategia di controllo dovrebbe essere utilizzata? ecc.
...
Ogni modello presenta diverse prospettive sull'[[3.3 Architettura|architettura]].
...
I sottosistemi devono scambiare dati: i dati condivisi sono conservati in un [[2.4 Database|database]] o repository centrale e possono essere consultati da tutti i sottosistemi; ciascun sottosistema mantiene il proprio [[2.4 Database|database]] e passa i dati esplicitamente ad altri sottosistemi.
...
Tuttavia, richiede un formato comune per il trasferimento dei dati lungo la pipeline ed è difficile supportare l'interazione basata sugli [[2.4 Eventi|eventi]].
...
Abbiamo anche un controllo basato sugli [[2.4 Eventi|eventi]]: ciascun sottosistema può rispondere a [[2.4 Eventi|eventi]] generati esternamente da altri sottosistemi o dall'ambiente del sistema.
...
## Sistemi basati su [[2.4 Eventi|eventi]]

Guidato da [[2.4 Eventi|eventi]] generati esternamente in cui la tempistica dell'evento è al di fuori del controllo dei sottosistemi che elaborano l'evento.
...
I sottosistemi registrano un interesse per [[2.4 Eventi|eventi]] specifici. Quando questi si verificano, il controllo viene trasferito al sottosistema che può gestire l'evento.

Il criterio di controllo non è incorporato nell'evento e nel gestore dei messaggi. I sottosistemi decidono sugli [[2.4 Eventi|eventi]] di loro interesse.
