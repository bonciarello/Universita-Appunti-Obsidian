...
- progettare l'[[3.3 Architettura|architettura]] del sistema;
...
- **Modello di utilizzo del sistema:** un modello dinamico che descrive come il sistema interagisce con il suo ambiente. Usa [[2.2 Casi d'uso|casi d'uso]] per mostrare le interazioni.

## [[3.3 Architettura|Architettura]] a strati

![[architetturaStrati.png]]

## [[2.2 Casi d'uso|Casi d'uso]] per la stazione meteorologica

Per dare un rapido accesso ai requisiti, si utilizza il diagramma dei [[2.2 Casi d'uso|casi d'uso]].
...
Una volta comprese le interazioni tra il sistema e il relativo ambiente, si utilizzano queste informazioni per progettare l'[[3.3 Architettura|architettura]] del sistema.
