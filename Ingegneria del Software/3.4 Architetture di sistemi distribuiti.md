...
L'[[0.00 Ingegneria del Software|ingegneria del software]] distribuito è quindi molto importante per i sistemi informatici aziendali.
...
## [[3.3 Architettura|Architettura]] dell'applicazione a più livelli
...
- **strato della gestione dati ([[2.4 Database|database]]):** si occupa della gestione dei [[2.4 Database|database]] di sistema.
...
In un'[[3.3 Architettura|architettura]] a tre livelli, ciascuno dei livelli dell'[[3.3 Architettura|architettura]] della applicazione può essere eseguito su un processore separato.
...
Un'[[3.3 Architettura|architettura]] più scalabile: all'aumentare delle richieste, è possibile aggiungere server aggiuntivi.
...
- è un'[[3.3 Architettura|architettura]] di sistema molto aperta che consente di aggiungere nuove risorse secondo necessità;
...
Abbiamo due tipi di [[3.3 Architettura|architettura]] peer-to-peer:

- [[3.3 Architettura|architettura]] p2p decentralizzata: 
  ![[decentralizzato.png]]

- [[3.3 Architettura|architettura]] p2p semi-centralizzata: 
