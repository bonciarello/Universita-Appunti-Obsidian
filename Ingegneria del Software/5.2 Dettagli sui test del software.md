...
**I [[2.2 Casi d'uso|casi d'uso]] possono essere una base per derivare i test per un sistema:** aiutano a identificare le operazioni da testare e aiutano a progettare i casi di test richiesti.
...
**Il test è una fase di processo costosa.** I banchi di prova forniscono una gamma di strumenti per ridurre il tempo richiesto e i costi totali di prova. Sistemi come [[8.2 JUnit|Junit]] supportano l'esecuzione automatica dei test.
