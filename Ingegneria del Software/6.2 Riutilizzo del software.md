...
- **Linee di prodotti applicativi:** un tipo di applicazione è generalizzato attorno a un'[[3.3 Architettura|architettura]] comune in modo che possa essere adattato in modi diversi per i diversi clienti;
...
- **[[1.4 Sviluppo software|Sviluppo software]] orientato all'aspetto:** i componenti condivisi vengono intrecciati in un'applicazione in punti diversi quando il programma viene compilato.
...
I modelli si basano spesso su caratteristiche dell'oggetto come l'ereditarietà e il [[2.2 Polimorfismo|polimorfismo]].
