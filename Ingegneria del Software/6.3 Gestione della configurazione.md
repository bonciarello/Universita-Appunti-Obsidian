...
- Definisce il [[2.4 Database|database]] CM utilizzato per registrare le informazioni di configurazione.
...
Utilizzare un [[2.4 Database|database]] di configurazione collegato a risorse.
