...
- il numero di moduli di programma che devono essere sviluppati per integrare il codice del [[2.4 Database|database]].
...
- **Esperienza nel dominio dell'applicazione:** la conoscenza del dominio dell'applicazione è essenziale per uno [[1.4 Sviluppo software|sviluppo software]] efficace. È probabile che gli ingegneri che già comprendono un dominio siano i più produttivi;
...
- **Supporto tecnologico:** una buona tecnologia di supporto come gli strumenti CASE, i sistemi di [[6.3 Gestione della configurazione|gestione della configurazione]], ecc. può migliorare la produttività;
...
- **Giudizio di esperti:** vengono consultati diversi esperti sulle tecniche di [[1.4 Sviluppo software|sviluppo software]] proposte e sul dominio applicativo. Ciascuno stima il costo del progetto. Queste stime vengono confrontate e discusse. Il processo di stima scorre fino al raggiungimento di una stima concordata;
...
- **Modello post-[[3.3 Architettura|architettura]]:** utilizzato una volta che l'[[3.3 Architettura|architettura]] del sistema è stata progettata e sono disponibili ulteriori informazioni sul sistema.