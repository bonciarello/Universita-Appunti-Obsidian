...
## Binding dinamico e [[2.2 Polimorfismo|polimorfismo]]
...
Se i metodi sono stati ridefiniti (come nel caso di TestObject2) il binding dinamico invocherà il metodo corrispondente (**[[2.2 Polimorfismo|polimorfismo]]**).
...
Le classi generiche in Java sono **costrutti sintattici** per gestire una forma di **[[2.2 Polimorfismo|polimorfismo]] dinamico**.
