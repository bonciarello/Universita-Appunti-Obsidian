...
Per quanto riguarda il file *ChatFrameController.java*, si genere su [[3.1 JavaFX|JavaFX]] Scene Builder tramite *View → Show Sample Controller Skeleton*. Otterremo un file del genere:
