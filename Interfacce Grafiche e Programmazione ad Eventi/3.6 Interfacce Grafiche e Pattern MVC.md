...
Le persone tendono a preferire le cose già [[3.4 Viste|viste]] in passato.
...
- **Gerarchico:** Organizzare le informazioni in ordine gerarchico, quando un pezzo di informazione è connesso ad un altro in ordine di importanza o valore. *Es.* la visualizzazione dei file in un [[3.2 File System|file system]]
...
I colori possono essere utilizzati per evidenziare [[2.4 Eventi|eventi]] eccezionali.
...
Si utilizza il **pattern MVC**, [[3.3 Architettura|architettura]] software che permette di separare le componenti principali di un'interfiia grafica: la rappresentazione dell'informazione e l'interazione con l'utente.
...
- **tanti Controller:** fanno da intermediari tra il Model e View. Gestisce le azioni degli utenti e li mappa su azioni sul modello. Quindi, in generale è responsabile della gestione degli [[2.4 Eventi|eventi]].
