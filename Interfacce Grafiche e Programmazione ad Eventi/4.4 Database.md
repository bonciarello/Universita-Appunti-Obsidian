...
- Scaricare il driver JDBC da *https://repo1.[[8.3 Maven|maven]].org/maven2/org/xerial/sqlite-jdbc/3.34.0/sqlite-jdbc-3.34.0.jar* ;
...
Si può anche usare [[8.3 Maven|maven]] inserendo la dipendenza nel POM (*https://mvnrepository.com/artifact/org.xerial/sqlite-jdbc*).
