...
- *rischi e imprevisti:* elenco dei rischi o degli [[2.4 Eventi|eventi]] che potrebbero ritardare il progetto o causarne il fallimento e elenco delle azioni da intraprendere se si presentano i rischi;
...
In questa fase penseremo a determinare come devono essere utilizzati i risultati, chi deve utilizzarli, quanto spesso devono essere utilizzati e alla distribuire i risultati del data mining assegnando un punteggio a un [[2.4 Database|database]] e sfruttando i risultati come regole aziendali.
