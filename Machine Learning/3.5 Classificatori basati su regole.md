...
Mettendo le *regole di classificazione* in relazione con gli *[[3.4 Alberi decisionali|alberi decisionali]]* avremo una regola per ogni nodo foglia. 
...
- altamente espressivi come gli [[3.4 Alberi decisionali|alberi decisionali]];
- facile da interpretare;
- può classificare rapidamente nuove istanze;
- prestazioni paragonabili agli [[3.4 Alberi decisionali|alberi decisionali]].
