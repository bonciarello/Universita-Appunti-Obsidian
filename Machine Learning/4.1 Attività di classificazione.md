...
È l'apprendimento degli [[3.4 Alberi decisionali|alberi decisionali]] dai record di formazione etichettati in classe. Un albero decisionale è una struttura ad albero in cui:
...
dove $E(T)$ è l'[[3.3 Entropia|entropia]] di $T$ prima della divisione ed $E_A(T)$ è l'[[3.3 Entropia|entropia]] di $T$ dopo la divisione su $A$. L'attributo $A$ con il maggior guadagno di informazioni (*Gain(A)*) viene scelto come attributo di suddivisione.
