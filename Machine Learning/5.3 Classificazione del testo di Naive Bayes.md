...
- **rappresentazione binaria:** 0 o 1, per indicare l’assenza o la presenza di una parola nel documento. I documenti sono visti come istanze, mentre le parole sono [[3.4 Viste|viste]] come attributi;
- **rappresentazione di frequenza:** numero di volte in cui una parola (o N-gram) appare in un documento. Anche in questa rappresentazione, i documenti sono visti come istanze, mentre le parole sono [[3.4 Viste|viste]] come attributi.
...
4. **Features Selection (FS):** vengono selezionati gli attributi con il più alto potere discriminante, quelli che appaiono solo nei documenti di una particolare classe (bassa [[3.3 Entropia|entropia]]). È benefica in quanto riduce il rumore e riducendo la dimension incrementa l’efficienza.
