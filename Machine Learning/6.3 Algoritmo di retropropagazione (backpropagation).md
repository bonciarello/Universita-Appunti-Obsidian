...
---
**Backpropagation** è un algoritmo per l'addestramento di [[0.00 Reti|reti]] neurali feedforward. È una procedura iterativa che utilizza la regola della catena per le derivate per modificare i pesi dall'output allo strato di input, al fine di ridurre l'errore.
...
## Funzione di costo dell'[[3.3 Entropia|entropia]] incrociata
...
Tale funzione è l'**[[3.3 Entropia|entropia]] incrociata**: 
...
Le *proprietà della funzione di [[3.3 Entropia|entropia]]* incrociata: 
