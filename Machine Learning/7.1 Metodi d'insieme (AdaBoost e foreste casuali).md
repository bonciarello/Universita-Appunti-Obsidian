...
Una **foresta casuale (RF)** è un **insieme $K$ di [[3.4 Alberi decisionali|alberi decisionali]]**. Gli [[3.4 Alberi decisionali|alberi decisionali]] sono sensibili a entrambi:
