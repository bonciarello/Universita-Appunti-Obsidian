...
---
Il **Control Hijacking** è una categoria di attacchi in cui un aggressore prende il controllo di un sistema o programma senza autorizzazione. L'obiettivo è ottenere un accesso non autorizzato per rubare dati, danneggiare il sistema o comprometterne la [[3.1 Sicurezza|sicurezza]].
...
### Perché persistono?
*   Presenza di codice **legacy** non orientato alla [[3.1 Sicurezza|sicurezza]].
