...
3.  La **policy** di [[3.1 Sicurezza|sicurezza]].
...
*   **chroot:** Cambia la directory root apparente per un processo, confinandolo in una porzione del [[3.2 File System|file system]].
...
### OKWS (OK Web Server)
Progettato per la massima [[3.1 Sicurezza|sicurezza]] (siti di dating), OKWS divide le funzionalità in moduli specializzati:
...
*   **dbproxy:** Un intermediario critico che isola il [[2.4 Database|database]].
