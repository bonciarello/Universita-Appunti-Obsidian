...
*   **[[3.1 JavaScript|JavaScript]]:** Isolamento logico all'interno del browser.
*   **Strumentazione Binaria (NativeClient):** Modifica o verifica il codice eseguibile per garantirne la [[3.1 Sicurezza|sicurezza]].

## 3. Sandboxing x86 nei Browser
L'obiettivo è eseguire codice nativo (C/C++) nel browser per ottenere alte prestazioni (giochi, editing video) o supportare app legacy, senza compromettere la [[3.1 Sicurezza|sicurezza]] dell'host.
