...
Ad oggi, la [[3.1 Sicurezza|sicurezza]] di rete deve rispondere a sei sfide:
...
4.  Impedire l'uso malevolo di [[3.1 JavaScript|JavaScript]] lato client.
...
*   **[[2.1 Crittografia Simmetrica|Crittografia simmetrica]]:** AES, 3DES, RC4.
...
4.  **Change Cipher Spec:** Messaggio che segnala il passaggio alla [[2.1 Crittografia Simmetrica|crittografia simmetrica]] per tutti i dati successivi.
...
*   **Contenuti Misti (Mixed Content):** Pagine HTTPS che caricano elementi (immagini, script) via HTTP. Un avversario può alterare questi elementi per compromettere la [[3.1 Sicurezza|sicurezza]] della pagina.
*   **[[2.1 Interfaccia utente|Interfaccia Utente]]:** Il simbolo del "lucchetto" indica solo che la connessione è cifrata e il certificato è valido, non necessariamente che il sito sia onesto.
