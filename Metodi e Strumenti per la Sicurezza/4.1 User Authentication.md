...
### Forza della Password ed [[3.3 Entropia|Entropia]]
La forza è misurata dall'[[3.3 Entropia|entropia]] (caos). Bit necessari per simbolo:
*   Cifre (base 10): 3.32 bit.
*   Lettere minuscole (az): 4.70 bit.
*   Caratteri ASCII stampabili (94): 6.55 bit.

**Il problema umano:** Le password non sono casuali. Nel 2016, le 5000 password più comuni coprivano il 20% degli utenti. L'[[3.3 Entropia|entropia]] reale è spesso di soli **20 bit**.
