...
### [[3.1 Sicurezza|Sicurezza]] (Security)
*   **Resilient-to-throttled-guessing:** resistenza a tentativi limitati (Password: NO, causa bassa [[3.3 Entropia|entropia]]).
...
*   **[[3.3 Entropia|Entropia]] stimata (2003):** Impronte (13.3 bit), Iride (19 bit), Voce (11.7 bit).
