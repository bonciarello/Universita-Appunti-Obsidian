---
aliases: [Design architetture sicurezza, DAS]
tags: [metodi-e-strumenti-per-la-sicurezza]
---
## 1. Progettazione Security-Aware
L'approccio corretto consiste nell'integrare la [[Sicurezza|sicurezza]] fin dall'inizio (**Security by Design**), non come un'aggiunta finale.
Le quattro fasi principali sono:
1.  **Requisiti:** Definire cosa proteggere.
2.  **Progetto:** Scegliere l'[[Architettura|architettura]].
...
*   **Hardware:** Difficile da cambiare ma offre vantaggi di [[Sicurezza|sicurezza]] non facilmente bypassabili.
...
A differenza dei [[Casi d'uso|casi d'uso]], descrivono ciò che il sistema **non deve permettere**.
...
*   **"Il cloud è sicuro di per sé":** Falso. La [[Sicurezza|sicurezza]] è una responsabilità condivisa (SLA).
...
*   **Titan (Chip di [[Sicurezza|sicurezza]]):** Ogni macchina Google ha un chip Titan che firma l'hash del BIOS e del SO all'avvio per garantire che l'infrastruttura sia fidata.
