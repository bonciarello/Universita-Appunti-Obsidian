---
aliases: [SCH, Sicurezza comunicazioni - HTTPS]
...
Ad oggi, la [[Sicurezza|sicurezza]] di rete deve rispondere a sei sfide:
...
*   **[[Crittografia Simmetrica|Crittografia simmetrica]]:** AES, 3DES, RC4.
...
4.  **Change Cipher Spec:** Messaggio che segnala il passaggio alla [[Crittografia Simmetrica|crittografia simmetrica]] per tutti i dati successivi.
...
*   **Contenuti Misti (Mixed Content):** Pagine HTTPS che caricano elementi (immagini, script) via HTTP. Un avversario può alterare questi elementi per compromettere la [[Sicurezza|sicurezza]] della pagina.
*   **[[Interfaccia utente|Interfaccia Utente]]:** Il simbolo del "lucchetto" indica solo che la connessione è cifrata e il certificato è valido, non necessariamente che il sito sia onesto.
