...
Nella [[3.1 Sicurezza|sicurezza]], è estremamente importante il **triangolo della CIA**:
...
La [[3.1 Sicurezza|sicurezza]] non riguarda solo la rete ma anche la parte fisica della rete stessa, come USB, plug e qualcosa del genere.
...
*   **Weakness:** una condotta generale che può portare alla generazione di minacce. Un [[2.4 Database|database]] contiene tutte le diverse weakness esistenti e si chiama **CWE** (Common Weakness Enumeration);
*   **Vulnerability:** un potenziale specifico di violazione della [[3.1 Sicurezza|sicurezza]], possiamo dire che una vulnerabilità è un caso particolare di weakness. Un [[2.4 Database|database]] contiene tutte le possibili vulnerabilità esistenti e si chiama **CVE** (Common Vulnerability Enumeration);
*   **Attacco:** un attacco alla [[3.1 Sicurezza|sicurezza]] del sistema, un tentativo deliberato di eludere il servizio di [[3.1 Sicurezza|sicurezza]].
