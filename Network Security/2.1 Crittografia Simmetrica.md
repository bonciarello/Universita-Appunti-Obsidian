...
2.  **[[3.1 Sicurezza|Sicurezza]] della Chiave:** il mittente e il destinatario devono aver ottenuto copie della chiave segreta in modo sicuro e devono conservare la chiave al sicuro: se qualcuno può scoprire la chiave e conosce l'algoritmo, tutte le comunicazioni che utilizzano questa chiave sono leggibili.
...
La [[3.1 Sicurezza|sicurezza]] del one-time pad è interamente dovuta alla casualità della chiave. Quindi, non ci sono modelli o regolarità che un crittoanalista può utilizzare per attaccare il testo cifrato. Il one-time pad offre una [[3.1 Sicurezza|sicurezza]] completa ma, in pratica, presenta due difficoltà fondamentali:
