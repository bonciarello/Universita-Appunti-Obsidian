...
Il primo algoritmo a chiave pubblica è lo **scambio di chiavi Diffie-Hellman**. Lo scopo dell'algoritmo è consentire a due utenti di scambiarsi in modo sicuro una chiave che può quindi essere utilizzata per la successiva [[2.1 Crittografia Simmetrica|crittografia simmetrica]] dei messaggi. L'algoritmo stesso è limitato allo scambio di valori segreti.
