...
Purtroppo, la [[3.1 Sicurezza|sicurezza]] non viene tutelata in alcun modo, infatti:
...
L'ultima versione delle [[6.3 Reti Wi-Fi|reti Wi-Fi]] è la rete **WPA (Wi-Fi Protected Access)**. Le [[0.00 Reti|reti]] WPA possono essere suddivise in due tipi di rete:
...
L'uso e la generazione di una chiave segreta sono molto complessi nelle [[0.00 Reti|reti]] WPA. Esistono due tipi di chiavi:
