...
---
Nel corso degli anni, diversi problemi ed esigenze sono sorti durante l'utilizzo delle [[0.00 Reti|reti]]:
...
*   Mantenere l'anonimato aggiungendo così un livello di [[3.1 Sicurezza|sicurezza]] e privacy;
...
> **Commentato [CP14]:** Exploiting Geographic Proxying è una tecnica usata per ingannare sistemi di [[3.1 Sicurezza|sicurezza]] basati sulla localizzazione geografica.

## 1. Tipologie di VPN
Esistono diversi tipi di VPN:
*   **VPN per Roadwarriors:** questo tipo di VPN è utilizzato da utenti mobili (road warriors) che si connettono da diverse posizioni remote, come lavoratori in viaggio o da casa. Un uso tipico è consentire a singoli utenti di accedere alla rete aziendale da qualsiasi luogo, garantendo [[3.1 Sicurezza|sicurezza]] e privacy;
*   **VPN LAN-2-LAN:** questo tipo di VPN collega due o più [[0.00 Reti|reti]] locali (LAN) situate in posizioni diverse, creando un tunnel sicuro tra di esse. Un uso tipico è collegare uffici o sedi aziendali dislocate geograficamente in una rete aziendale unificata;
*   **VPN Many-To-Many:** questo tipo di VPN connette molte [[0.00 Reti|reti]] o nodi a molte altre [[0.00 Reti|reti]] o nodi, formando una rete complessa e interconnessa. Un uso tipico è in scenari in cui diverse [[0.00 Reti|reti]] aziendali o partner commerciali devono comunicare tra loro in modo sicuro e coordinato.
...
## 4. Secure VPN
Recentemente, le VPN stanno diventando sempre più utilizzate ed è richiesto un certo grado di [[3.1 Sicurezza|sicurezza]]. Di conseguenza, nasce **Secure VPN** e sono caratterizzati da:
...
*   **[[7.2 IPSec|IPsec]];**
*   **[[7.2 IPSec|IPSec]] + L2TP + IKEv2:** è la tecnologia più all’avanguardia. [[7.2 IPSec|IPSec]] viene usato per la crittografia e la firma digitale. L2TP serve per il tunneling delle informazioni del layer 2, mentre IKEv2 serve per lo scambio delle chiavi e per l’autenticazione.
