...
Numerosi algoritmi e protocolli di sicurezza di rete basati sulla crittografia utilizzano numeri binari casuali. Queste applicazioni danno luogo a due requisiti distinti e non necessariamente compatibili per una sequenza di numeri casuali:
...
Un **TRNG** prende come input una fonte che è effettivamente casuale e la sorgente è spesso indicata come **fonte di entropia**: quest’ultima è ricavata dall’ambiente fisico del computer e potrebbe includere cose come schemi temporali di battitura, attività elettrica del disco, movimenti del mouse e valori istantanei dell’orologio di sistema.
