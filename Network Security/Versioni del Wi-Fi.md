...
Purtroppo, la [[Sicurezza|sicurezza]] non viene tutelata in alcun modo, infatti:
...
L'ultima versione delle [[Reti Wi-Fi|reti Wi-Fi]] è la rete **WPA (Wi-Fi Protected Access)**. Le [[Reti|reti]] WPA possono essere suddivise in due tipi di rete:
...
L'uso e la generazione di una chiave segreta sono molto complessi nelle [[Reti|reti]] WPA. Esistono due tipi di chiavi:
