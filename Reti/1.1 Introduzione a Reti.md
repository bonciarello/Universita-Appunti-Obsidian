...
tags: [reti]
---
## [[0.00 Reti|Reti]] e [[3.1 Sicurezza|sicurezza]] informatica
La [[3.1 Sicurezza|sicurezza]] informatica e le [[0.00 Reti|reti]] vanno di pari passo ed è illegale entrare in sistemi privati altrui come riportano i seguenti articoli del Codice Penale:
- **art.615 ter del Codice Penale:** *chiunque abusivamente si introduce in un sistema informatico o telematico protetto da misure di [[3.1 Sicurezza|sicurezza]] ovvero vi si mantiene contro la volontà espressa o tacita di chi ha il diritto di escluderlo, è punito con la reclusione sino a tre anni*;
...
## Access networks: la rete delle [[0.00 Reti|reti]]
