...
Le [[6.3 Reti Wi-Fi|reti Wi-Fi]] soffrono di numerosi tempi idling e soprattutto l'intero sistema di comunicazione è sincronizzato temporalmente, infatti se l'ACK esplicito non arriva nel tempo prestabilito il messaggio si dà per "colliso". 

Le [[6.3 Reti Wi-Fi|reti Wi-Fi]] vengono identificate da:
...
Le [[6.3 Reti Wi-Fi|reti Wi-Fi]] sono un esempio di *FDMA (Frequency Division Multiplexing Access)* e cioè sfruttano un meccanismo di turnificazione del canale di comunicazione in funzione della banda di frequenza. 
