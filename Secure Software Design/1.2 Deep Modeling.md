...
Immaginiamo di avere un sito di vendita di libri. Nell’immagine possiamo vedere un problema scoperto durante un controllo di [[3.1 Sicurezza|sicurezza]].

![](img/sezione3/bookShop1.png)

L'infrastruttura sembra solida, mentre la squadra di [[3.1 Sicurezza|sicurezza]] si mette a curiosare: sonda i firewall, scansionano le porte aperte del sistema operativo, lanciano pacchetti dannosi al server web, eppure tutto funziona bene. 
Non è una grande sorpresa: al giorno d'oggi, i problemi di [[3.1 Sicurezza|sicurezza]] problemi di [[3.1 Sicurezza|sicurezza]] sono raramente il risultato di un'infrastruttura non funzionante. Abbiamo imparato che le cose che non dovrebbero essere esposte al pubblico dovrebbero essere tagliate fuori dal pubblico.
...
Il problema della [[3.1 Sicurezza|sicurezza]] attraversa diversi moduli del sistema. Il modulo di fatturazione stabilisce che è previsto un pagamento. Il modulo di contabilità rileva un addebito da saldare il prima possibile.
