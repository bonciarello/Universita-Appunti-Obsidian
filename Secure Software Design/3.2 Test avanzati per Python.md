...
Come spinto dal modello di [[3.3 Architettura|architettura]] pulita, siamo interessati a separare i diversi livelli del sistema: ricorda che ci sono diversi modi per implementare i concetti di [[3.3 Architettura|architettura]] pulita e il codice che puoi inventare dipende fortemente da ciò che la tua lingua preferita ti consente di fare.
