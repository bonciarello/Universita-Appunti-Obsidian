...
- **Case studies:** Linux, Windows, [[0.00 Sistemi Operativi|Sistemi Operativi]] Mobili.
...
- *gestire la memoria secondaria (dischi fissi, ecc.)* con mappatura sul dispositivo fisico, organizzazione e [[1.7 Gestione degli errori|gestione degli errori]];
- **gestire i processi e i thread** con scheduling e accesso condiviso alle risorse;
- *gestire gli [[2.4 Eventi|eventi]] e l'[[2.1 Interfaccia utente|interfaccia utente]]* con cattura e smistamento degli [[2.4 Eventi|eventi]] ai processi;
...
Nella costruzione di un SO, la tecnica della [[0.00 Programmazione ad oggetti|programmazione ad oggetti]] è molto più lenta rispetto alle funzioni pure. Si utilizza, quindi, il *linguaggio C* nudo e crudo.
