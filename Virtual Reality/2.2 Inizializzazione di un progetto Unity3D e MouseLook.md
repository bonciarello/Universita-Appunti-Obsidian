...
## Coordinate mancine
Generalmente X va a destra e Y sale, ma ora abbiamo anche l'asse Z che entra o esce dalla pagina/schermo. [[2.1 Unity3D|Unity3D]] utilizza un **sistema di coordinate per mancini** come di seguito:
