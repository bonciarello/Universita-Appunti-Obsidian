...
Abbiamo bisogno di un componente *Text* collegato al *GameObject*, per questo utilizziamo l'attributo *RequireComponent*, aggiungiamo anche il namespace *UnityEngine.UI* che contiene tutte le funzionalità dell'[[2.1 Interfaccia utente|interfaccia utente]]:
```csharp
using UnityEngine;
...
## Barra della salute
Andremo a vedere come si crea l'oggetto dell'[[2.1 Interfaccia utente|interfaccia utente]] della barra della salute:
