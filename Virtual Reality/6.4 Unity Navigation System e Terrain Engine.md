...
Alcuni [[2.2 Casi d'uso|casi d'uso]] per i collegamenti fuori rete possono essere rilevati automaticamente. I due più comuni sono: *Drop-Down* e *Jump-Across*. Questo viene fatto selezionando l'opzione *Generate Off-Mesh Links* nella finestra di navigazione nella scheda *Objects*.
