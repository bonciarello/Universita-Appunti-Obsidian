...
Recentemente sempre più persone hanno iniziato a usare il termine VR esclusivamente per l'esperienza immersiva supportata da una gamma relativamente piccola di display VR.
...
Il termine "realtà virtuale" (VR) è stato reso popolare da Jaron Lanier nel 1980.
Nel 1990, la VR è stata utilizzata per l'addestramento e la simulazione nelle forze armate statunitensi e nella National Aeronautics and Space Administration (NASA).
La produzione in serie di sistemi VR iniziò all'inizio del 1991, guidata da Virtuality, che aprì sale giochi VR dedicate.

I dispositivi VR contemporanei sono emersi con l'introduzione del prototipo Oculus Rift connesso al PC nel 2010.
...
- *1991*: viene introdotta la prima **macchina arcade VR**, di Virtuality Group. Le macchine offrono giochi in tempo reale tramite una visiera stereoscopica, joystick e unità in rete per giochi multigiocatore.
- *2010*: è stato progettato il **primo prototipo del visore Oculus Rift**. Questo nuovo sviluppo ha stimolato e rinnovato l'interesse per la realtà virtuale. Nel 2012 una campagna Kickstarter per Oculus Rift ha raccolto 2,4 milioni di dollari.
- *2014-2017*: 
    - **Facebook** ha acquistato la società Oculus VR. Questo è stato un momento decisivo nella storia della realtà virtuale perché, in seguito, la realtà virtuale ha guadagnato popolarità molto rapidamente;
    - **Sony** ha annunciato che stavano lavorando a Project Morpheus, un visore VR per PS4;
    - **Google** ha rilasciato Cardboard, un visualizzatore stereoscopico fai-da-te per smartphone a basso costo;
