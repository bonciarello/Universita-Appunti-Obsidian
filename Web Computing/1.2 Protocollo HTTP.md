...
> - **Risorsa:** Qualsiasi oggetto identificabile sul web (pagina [[2.1 HTML|HTML]], immagine, servizio API).
...
| **Percorso (Path)** | `/blog/articolo` | Posizione della risorsa nel [[3.2 File System|file system]] del server. |
...
4.  **Message-Body:** Il contenuto vero e proprio (es. [[2.1 HTML|HTML]] della pagina o dati di un form).
...
### [[3.1 Sicurezza|Sicurezza]] e Autenticazione
