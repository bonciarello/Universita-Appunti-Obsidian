...
Combina layout fluidi con **Media Queries** (`@media`) per cambiare struttura a determinati "punti di rottura" (breakpoints). È quello che fa [[2.4 Bootstrap|Bootstrap]].
