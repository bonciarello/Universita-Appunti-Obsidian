...
tags: [web-computing]
---
**Bootstrap** è il framework CSS più popolare al mondo per lo sviluppo di siti responsive e mobile-first. Fornisce una collezione di stili CSS predefiniti e componenti [[3.1 JavaScript|JavaScript]] (modali, carousel, tooltip) pronti all'uso.
## Installazione
