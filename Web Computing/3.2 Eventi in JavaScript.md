...
tags: [web-computing]
---
Gli [[2.4 Eventi|eventi]] sono il cuore dell'interattività in [[3.1 JavaScript|JavaScript]]. Permettono di eseguire codice in risposta ad azioni dell'utente (click, digitazione) o del browser (caricamento pagina).
## Gestione degli [[2.4 Eventi|Eventi]]
Esistono tre modi per gestire gli [[2.4 Eventi|eventi]].
### Attributi [[2.1 HTML|HTML]] (Sconsigliato)
...
## Flusso degli [[2.4 Eventi|Eventi]]: Bubbling vs Capturing
...
## Tipi di [[2.4 Eventi|Eventi]] Comuni
### Mouse
...
*   `DOMContentLoaded`: [[2.1 HTML|HTML]] caricato (senza aspettare le immagini). **Molto usato.**
