...
tags: [web-computing]
---
**jQuery** è una libreria [[3.1 JavaScript|JavaScript]] veloce e concisa che semplifica l'attraversamento del DOM, la gestione degli [[2.4 Eventi|eventi]], l'animazione e le interazioni [[3.5 Ajax|Ajax]]. Il suo motto è: *"Write less, do more"*.

> [!NOTE] Nota Storica
> Oggi molte funzioni di jQuery sono integrate nativamente in [[3.1 JavaScript|JavaScript]] (ES6+), ma jQuery rimane fondamentale per lavorare su codice legacy e per la sua semplicità sintattica.
## Inizializzazione
...
```
## Effetti e [[5.3 Animazioni|Animazioni]]
...
*   `$("#div").load("pagina.html")`: Carica [[2.1 HTML|HTML]] remoto dentro un elemento.
## Estensioni (Plugin)
