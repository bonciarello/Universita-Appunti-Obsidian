...
## [[3.3 Architettura|Architettura]] 3-Tier
Le applicazioni web moderne sono divise in tre livelli logici:
1.  **Presentation Tier:** L'[[2.1 Interfaccia utente|interfaccia utente]] ([[2.1 HTML|HTML]], CSS, JS).
2.  **Logic Tier:** Il cervello dell'app (Servlet, Application Server come Tomcat). Si occupa della decodifica richieste, logica di business e [[3.1 Sicurezza|sicurezza]].
3.  **Persistence Tier:** Dove i dati vengono salvati ([[2.4 Database|Database]], RDBMS).
