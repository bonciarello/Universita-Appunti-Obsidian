...
tags: [web-computing]
---
Le **JSP** (*Java Server Pages*) sono una tecnologia lato server che permette di creare pagine web dinamiche mischiando codice [[2.1 HTML|HTML]] statico con frammenti di codice Java.
...
Esistono diversi tipi di tag per inserire logica Java in una pagina [[2.1 HTML|HTML]].
### Scriptlet: `<% ... %>`
