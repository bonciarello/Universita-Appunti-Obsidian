...
> [!WARNING] Importante
> *   **Same-Origin Policy:** Per [[Sicurezza|sicurezza]], Ajax può fare richieste solo allo stesso dominio da cui è stata caricata la pagina (salvo configurazioni CORS o uso di JSONP).
