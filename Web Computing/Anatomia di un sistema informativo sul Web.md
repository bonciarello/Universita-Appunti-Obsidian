...
*   **Web (WWW):** È uno dei tanti servizi che girano *sopra* Internet, basato su documenti ipertestuali (HTML) e il protocollo HTTP.
...
### CRUD
Le 4 operazioni fondamentali su ogni database:
*   **C**reate (INSERT)
*   **R**etrieve (SELECT)
*   **U**pdate (UPDATE)
*   **D**elete (DELETE)
### ORM (Object Relational Mapping)
Librerie che permettono di gestire i dati del database come se fossero normali oggetti Java, automatizzando la scrittura del codice SQL noioso e ripetitivo.
