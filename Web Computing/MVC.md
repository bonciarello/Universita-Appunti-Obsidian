...
tags: [web-computing]
---
Il pattern **MVC** è l'[[Architettura|architettura]] standard per separare la logica di business dall'[[Interfaccia utente|interfaccia utente]] nelle applicazioni web. Dividere un'app in queste tre componenti facilita la manutenibilità e il lavoro di squadra.
## Le Componenti
### Model (Il Dato)
...
3.  **Model:** Esegue il calcolo o interroga il [[Database|database]] e restituisce un oggetto (es. `Utente`).
...
```
## Vantaggi di MVC
*   **Separazione delle responsabilità:** Se voglio cambiare il [[Database|database]], tocco solo il Model. Se voglio cambiare il look, tocco solo la View.
